...
*tondeuse: représente l'implémentation du besoin
*io: spécifie les entrées/sorties du système
*move: ensemble de classes gérant le deplacement
...
Gestionnaire de source: Git - repository: https://github.com/hippocortex/MowItNow
Gestionnaire de projet: Maven
IDE: Eclipse IDE 2019‑09
Tests: JUnit 5
